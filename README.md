...
SIMULATE_HUMAN_TYPING=True/False #模拟人工回复延迟，建议设置为True避免被平台风控

注意：默认使用的模型是通义千问，如需使用其他API，请自行修改.env文件中的模型地址和模型名称；
COOKIES_STR自行在闲鱼网页端获取cookies(网页端F12打开控制台，选择Network，点击Fetch/XHR,点击一个请求，查看cookies)

注意：Cookie有效期较短，通常需要每隔几天重新获取，建议设置提醒定期更新。

> 💡 个人经验：我用的是 DeepSeek API，价格便宜效果不错，MODEL_BASE_URL 填 https://api.deepseek.com，MODEL_NAME 填 deepseek-chat 即可。
